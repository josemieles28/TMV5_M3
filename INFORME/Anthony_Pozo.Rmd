...
```{r echo=FALSE, message=FALSE, fig.height= 2.5, fig.width=9 }
library(haven)
...
MYEDA <- function (x, trim = 0.05) 
{
 ...
 # par(mfrow = c(2, 2))
  ...
  names(TOT) <- c("Tamaño (n)", "Perdidos", "Minimo", 
                  " 1st Cuartil", "Media", " Mediana", "Media Ajustada", 
                  " 3rd Cuartil", "Maximo.", " Desviacion Estandar.", "Varianza.", 
                  "Error Estandar de la Media", "Rango Intercuartil", "Rango", "Curtosis", 
                  "Asimetria", "Prueba de Normalidad ST")
