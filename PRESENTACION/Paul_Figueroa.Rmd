...
<center> <h2><span style="color:red"> Nivel de instrucción de la madre </span></h2> </center>
```{r echo=FALSE, message=FALSE, warning=FALSE}
...
##
<center> <h1><span style="color:red"> Modelo de regresión lineal </span></h1> </center> 
